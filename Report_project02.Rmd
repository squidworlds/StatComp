...
formulas <- list(m_0, m_0_start_year_cubed, m_0_year_te_daytype, m_prestep, m_both, m_0_year_te, m_aliya)
names <- c("m0", "Poly start_year, TE, interactions", "Poly start_year, TE, interactions, poly daytype", "Prestep", "Backward and Forward", "No interactions", "Aliya")
...
aliya_scores <- monthly_rolling_model(demand, m_aliya)
aliya_scores$model <- "Aliya"

all_scores <- rbind(m0_scores, backward_scores, interactionless_scores)
